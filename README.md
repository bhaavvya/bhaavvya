...
<svg xmlns="http://www.w3.org/2000/svg" width="467" height="195" viewBox="0 0 467 195" fill="none" role="img" aria-labelledby="descId">
        <title id="titleId">Bhavya Verma's GitHub Stats, Rank: C+</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits in 2023 : 0, Total PRs: 60, Total Issues: 0, Contributed to (last year): 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 195.78477317233106;
      }
    }
    ...
    @keyframes fadeInAnimation {
      ...
      to {
        ...
        <rect data-testid="card-bg" x="0.5" y="0.5" rx="4.5" height="99%" stroke="#e4e2e2" width="466" fill="#1a1b27" stroke-opacity="1"/>

        
      <g data-testid="card-title" transform="translate(25, 35)">
        <g transform="translate(0, 0)">
      <text x="0" y="0" class="header" data-testid="header">Aman Sahu's GitHub Stats</text>
    </g>
      </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="prs">60</text>
    </g>
